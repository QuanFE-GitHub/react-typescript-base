...
const FriendList = () => {
  ...
  const onChange = (e: CheckboxChangeEvent) => {
    ...
    if (!e.target.checked) {
      ...
      dataArr.splice(id, 1);
      console.log(`dataArr splice = `, dataArr);
      return;
    }
...
const FriendListDefault = {};

FriendList.defaultProps = FriendListDefault;
